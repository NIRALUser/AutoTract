...
IF(Qt4_SUPPORT)
  ...
  list(APPEND ${PRIMARY_PROJECT_NAME}_DEPENDENCIES ${${PRIMARY_PROJECT_NAME}_DEPENDENCIES} Qt4 )
ELSE()
  message(STATUS "-----------------------------Qt5 Support------------------------------")
  list(APPEND ${PRIMARY_PROJECT_NAME}_DEPENDENCIES ${${PRIMARY_PROJECT_NAME}_DEPENDENCIES} Qt5 )
ENDIF()
